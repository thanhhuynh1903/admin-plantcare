...
import "./SeedsDetailPage.scss";
import { aget } from "../../../utils/util_axios";
import SeedsEditDialog from "./SeedsEditDialog";
import SeedsDetailDeleteDialog from "./SeedsDetailDeleteDialog";

export default function SeedsDetailPage() {
  const [product, setSeeds] = useState(null);
  ...
  useEffect(() => {
    ...
    setPageHeadTitle("Seed detail");
    obtainSeedsAPI();
  }, []);

  return (
    <div className="seeds-detail-page">
      <div className="main-label">
        <Button component={Link} to="/seeds">
          <ArrowCircleLeftOutlinedIcon className="btn-back" />
        </Button>
        <p>Seed detail{product && ` - ${product.name}`}</p>
      </div>
